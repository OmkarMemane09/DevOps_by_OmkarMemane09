# 🏷️Kubernetes Namespaces Explained
...
- Ensures a fixed number of pods are running—if any pod crashes or is deleted, it starts a replacement.
- **Selectors:** Only supports *equality-based* selectors (`key = value`) for matching pods[web:149][web:159].
...
- **Selectors:** Supports *set-based* selectors, adding more flexibility (e.g., `key in (value1, value2)`)[web:149][web:159].
...
| Rolling Updates        | ❌ (no native support)        | ❌ (used by Deployments for rollouts) |
| Self-Healing           | ✅                           | ✅                             |
| Scaling                | ✅                           | ✅                             |
