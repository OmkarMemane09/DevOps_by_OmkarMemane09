#  Kubernetes HPA (Horizontal Pod Autoscaling) & VPA (Vertical Pod Autoscaling)
...
- High traffic → more CPU/Memory usage → need more pods  
- Low traffic → low usage → fewer pods
